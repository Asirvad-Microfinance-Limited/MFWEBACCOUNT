...
var _ApproveHostel = {
    ...
    checkAccess: function () {
        ...
        _http.post(MFPUBLICRENTAPI_URL + "api/accounts/RentHostelQueries", CheckAccess, _ApproveHostel.checkAccessRtn, token)
    },
    ...
    tokenValidate: function () {
        ...
        _http.post(MFPUBLICRENTAPI_URL + "api/accounts/UserSession", CheckToken, _ApproveHostel.checkAccessToken, userdata.token)
    },
    ...
    GetHostels: function () {
        ...
        _http.post(MFPUBLICRENTAPI_URL + "api/accounts/RentHostelQueries", GetRentDetails, _ApproveHostel.FillHostel, userdata.token)
    },
    ...
    GetHostelDetails: function () {
        ...
        _http.post(MFPUBLICRENTAPI_URL + "api/accounts/RentHostelQueries", GetRentDetails, _ApproveHostel.FillHostelDetails, userdata.token)
    ...
    LoadAssetDetails: function () {
        ...
        _http.post(MFPUBLICRENTAPI_URL + "api/accounts/RentHostelQueries", GetRentDetails, _ApproveHostel.TableLoadAssetDetails, userdata.token)
    ...
    ConfirmHostel: function () {
        ...
        _http.post(MFPUBLICRENTAPI_URL + "api/accounts/RentHostelQueries", confrim, _ApproveHostel.ConfirmResponse, userdata.token)
    },
    ...
    RejectHostel: function () {
        ...
        {
            flag: "AddNewHostalAprv",
            pagVal: "Add_New_Hostel_RejAtAprv",
            parVal: hostel_id + 'µ' + userdata.userId,
            typeID: "4",
            userID: userdata.userId,
            branchID: userdata.branchId
        ...
        _http.post(MFPUBLICRENTAPI_URL + "api/accounts/RentHostelQueries", confrim, _ApproveHostel.RejectResponse, userdata.token)
    },
...
jQuery('#DdlHostelName').change(function () {
    ...
    _ApproveHostel.GetHostelDetails();
    _ApproveHostel.LoadAssetDetails();
