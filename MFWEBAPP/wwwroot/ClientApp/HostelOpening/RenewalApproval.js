...
var _RenewalApprove = {
    ...
    checkAccess: function () {
        ...
        _http.post(MFPUBLICRENTAPI_URL + "api/accounts/RentHostelQueries", CheckAccess, _RenewalApprove.checkAccessRtn, token)
    },
    ...
    tokenValidate: function () {
        ...
        _http.post(MFPUBLICRENTAPI_URL + "api/accounts/UserSession", CheckToken, _RenewalApprove.checkAccessToken, userdata.token)
    },
    ...
    GetHostel: function () {
        ...
        var GetRentDetails =
        {
            flag: "Hostel_Renew_Agr_Aprv",
            pagVal: "loadHostelapr",
        ...
        _http.post(MFPUBLICRENTAPI_URL + "api/accounts/RentHostelQueries", GetRentDetails, _RenewalApprove.FillHostel, userdata.token)
    },
    ...
    LoadHostelDetails: function () {
        ...
        _http.post(MFPUBLICRENTAPI_URL + "api/accounts/RentHostelQueries", GetRentDetails, _RenewalApprove.TableLoadHostelDetails, userdata.token)
    ...
    ApproveRenewal: function () {
        ...
        _http.post(MFPUBLICRENTAPI_URL + "api/accounts/RentHostelQueries", confrim, _RenewalApprove.ConfirmResponse, userdata.token)
    },
    ...
    RejectRenewal: function () {
        ...
        _http.post(MFPUBLICRENTAPI_URL + "api/accounts/RentHostelQueries", confrim, _RenewalApprove.RejectResponse, userdata.token)
    },
...
jQuery('#view_areement').click(function () {
    ...
    _RenewalApprove.LoadHostelDetails();
});

jQuery('#BtnApprove').click(function () {

    _RenewalApprove.ApproveRenewal();
});

jQuery('#btnReject').click(function () {

    _RenewalApprove.RejectRenewal();
});
