var _GeneralServices = {
    ...
    LogOut: function () {
        ...
        _http.post(MFPUBLICRENTAPI_URL + "api/accounts/logout", logoutdata, _GeneralServices.logoutCompleted, userdata.token)
    },
...
function RemoveToken() {
    ...
    _http.post(MFPUBLICRENTAPI_URL + "api/accounts/UserSession", CheckLogout, _GeneralServices.checkAccessLogout, userdata.token);
}
